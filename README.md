...
A proposta do projeto é solucionar problemas lógicos utilizando funções javascript.
...
- Utilizar funções para organizar e estruturar o seu código;<br><br>
...
```javascript
cd projetos
git clone git@github.com:MarcusVMendes/trybe-playground-functions.git
```
<br>
